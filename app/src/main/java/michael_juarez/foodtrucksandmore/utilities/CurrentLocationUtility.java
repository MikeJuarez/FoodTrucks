            ...
            locationResult.addOnCompleteListener(this, new OnCompleteListener<Location>() {
                ...
                public void onComplete(@NonNull Task<Location> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(mActivity, "Sorry there was an error getting your current location.", Toast.LENGTH_LONG);
                    }
                }
            });
        } else {
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_FINE_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(mActivity, "Please enable location settings for this app to use this feature.", Toast.LENGTH_LONG).show();
                }
                return;
            }
